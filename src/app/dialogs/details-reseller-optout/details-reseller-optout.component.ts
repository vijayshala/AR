...
@Component({
  selector: 'app-details-reseller-optout',
  templateUrl: './details-reseller-optout.component.html',
  styleUrls: ['./details-reseller-optout.component.scss']
})
export class DetailsResellerOptoutComponent implements OnInit {
id: any;
  ...
  reason_codes: any = [];
  autorenew_Id: String;
  constructor(private fb: FormBuilder, public router: Router, private route: ActivatedRoute,public globalDateFormat: globalDateFormat,
    private snackBar: MatSnackBar, @Inject(MAT_DIALOG_DATA) public data: any,
    public dialog: MatDialog, public dialogRef: MatDialogRef< DetailsResellerOptoutComponent>,
