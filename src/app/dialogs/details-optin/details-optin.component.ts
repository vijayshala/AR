...
@Component({
  selector: 'app-details-optin',
  templateUrl: './details-optin.component.html',
  styleUrls: ['./details-optin.component.scss']
})
export class DetailsOptinComponent implements OnInit {
  id: any;
  ...
  result: any = [];
  autorenew_Id: String;
  constructor(private fb: FormBuilder,public globalDateFormat: globalDateFormat, public router: Router, private route: ActivatedRoute, private snackBar: MatSnackBar, @Inject(MAT_DIALOG_DATA) public data: any, public dialog: MatDialog, public dialogRef: MatDialogRef<DetailsOptinComponent>, public service: AutorenewService, public loader: LoaderService) { }
