...
@Component({
  selector: 'app-reselleroptindialog',
  templateUrl: './reselleroptindialog.component.html',
  styleUrls: ['./reselleroptindialog.component.scss']
})
export class ReselleroptindialogComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,public globalDateFormat: globalDateFormat,private snackBar: MatSnackBar, @Inject(MAT_DIALOG_DATA) public data: any, public dialog: MatDialog, public dialogRef: MatDialogRef<ReselleroptindialogComponent>, public service: AutorenewService, public loader: LoaderService) { }
